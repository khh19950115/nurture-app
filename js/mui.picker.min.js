...
!function (e, t, i, n) {
    ...
    p.prototype.findElementItems = function () {
        ...
        t.holder.addEventListener(e.EVENT_START, function (e) {
            ...
            if (a) {
                e.preventDefault();
                var r = (e.changedTouches ? e.changedTouches[0] : e).pageY, s = r - n, c = t.calcAngle(s),
                    l = s > 0 ? i - c : i + c;
        ...
        var t = this, i = e.changedTouches ? e.changedTouches[0] : e, n = e.timeStamp || Date.now(),
            a = (i.pageY - t.lastMoveStart) / (n - t.lastMoveTime), r = a > 0 ? -1 : 1, s = 6e-4 * r * -1,
            c = Math.abs(a / s), l = a * c / 2, o = t.list.angle, d = t.calcAngle(l) * r, u = d;
