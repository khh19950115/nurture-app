(function (mui, doc, $) {
    ...
    mui('body').on('tap', '.go-detail', function () {
        ...
        mui.openWindow({
            url: 'supermarket-instock-edit.html?id=' + row.id,
            createNew: true,
            styles: {
                cachemode:"noCache"
            }
    ...
    mui('body').on('tap', '.pro-add', function () {
        mui.openWindow({
            url: 'supermarket-instock-edit.html',
            createNew: true,
            styles: {
                cachemode:"noCache"
            }
    ...
    $.ajax({
        cache: false,
        type: 'get',
        url:Route.baseUrl + "/stock/instock/getSupplierSelect",
...
(function ($) {
    $('.management-list').on('tap', '.mui-btn.copy_btn', function (event) {
        ...
        mui.openWindow({
            url: 'supermarket-instock-edit.html?copy=true&id='+row.id,
            createNew: true,
            styles: {
                cachemode:"noCache"
            }
...
function reload(pageNumber,flag) {
    ...
    $.ajax({
        cache: false,
        type: 'get',
        url: common.isQuickTrace()? Route.baseUrl + "/stock/flashInStock/getInStockInfo": Route.baseUrl + "/stock/instock/getInStockInfo",
        data: {
            pageSize: 10,
            pageNumber: pageNumber || 1,
