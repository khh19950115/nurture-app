(function(mui, doc,$) {
	...
	mui('body').on('tap','.go-detail',function(){
        ...
        mui.openWindow({
            url: 'supermarket-outstock-edit.html?id=' + row.id,
            createNew: true,
            styles: {
                cachemode:"noCache"
            }
	...
	mui('body').on('tap','.pro-add',function(){
        mui.openWindow({
            url: 'supermarket-outstock-edit.html',
            createNew: true,
            styles: {
                cachemode:"noCache"
            }
    ...
    $.ajax({
        cache: false,
        type: 'get',
        url:Route.baseUrl + "/stock/outstock/getCustomerByEntpId",
...
(function($) {
    $('.management-list').on('tap', '.mui-btn.copy_btn', function (event) {
        ...
        mui.openWindow({
            url: 'supermarket-outstock-edit.html?copy=true&id='+row.id,
            createNew: true,
            styles: {
                cachemode:"noCache"
            }
...
function reload(pageNumber,flag) {
    ...
    $.ajax({
        cache: false,
        type: 'get',
        url: common.isQuickTrace()? Route.baseUrl + "/stock/flashoutstock/search": Route.baseUrl + "/stock/outstock/search",
        data: {
            pageSize: 10,
